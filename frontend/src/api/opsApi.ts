...
export const opsApi = {
  ...
  testingCreateOrder: () => apiFetch('/ops/testing/orders', { method: 'POST' }),
  testingListOrders: () => apiFetch('/ops/testing/orders'),
  testingDeleteOrder: (id: string) => apiFetch(`/ops/testing/orders/${id}`, { method: 'DELETE' }),
